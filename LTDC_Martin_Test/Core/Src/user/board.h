...
// ltdc defines
#define RGBLCD_M0_GPIO_Port GPIOG
#define RGBLCD_M0_Pin		GPIO_PIN_6

#define RGBLCD_M1_GPIO_Port GPIOI
#define RGBLCD_M1_Pin		GPIO_PIN_2

#define RGBLCD_M2_GPIO_Port GPIOI
#define RGBLCD_M2_Pin		GPIO_PIN_7
