...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    GPIO_InitStruct.Pin = Touch_Screen_SCL_Pin|Touch_Screen_SDA_Pin;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(Touch_Screen_SCL_GPIO_Port, Touch_Screen_SCL_Pin);

    HAL_GPIO_DeInit(Touch_Screen_SDA_GPIO_Port, Touch_Screen_SDA_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspInit 0 */
    ...
    PB4     ------> SPI1_MISO
    */
    GPIO_InitStruct.Pin = IMU_NSS_Pin|IMU_SCK_Pin|IMU_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PB4     ------> SPI1_MISO
    */
    HAL_GPIO_DeInit(GPIOA, IMU_NSS_Pin|IMU_SCK_Pin|IMU_MOSI_Pin);

    HAL_GPIO_DeInit(IMU_MISO_GPIO_Port, IMU_MISO_Pin);
  ...
  /* USER CODE END SPI5_MspDeInit 0 */
    ...
    PF9     ------> SPI5_MOSI
    */
    HAL_GPIO_DeInit(GPIOF, NRF_NSS_Pin|NRF_SCK_Pin|NRF_MISO_Pin|NRF_MOSI_Pin);
