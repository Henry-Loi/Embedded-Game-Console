...
void MX_GPIO_Init(void) {
	...
	/*Configure GPIO pin Output Level */
	HAL_GPIO_WritePin(GPIOB, LED2_Pin | LED1_Pin | IMU_CS_Pin | LCD_BL_Pin | LED8_Pin | LED7_Pin | LED6_Pin | LED5_Pin,
					  GPIO_PIN_RESET);
	...
	GPIO_InitStruct.Pin = RBTN_LEFT_Pin | Joy_L_Btn_Pin | Joy_R_Btn_Pin;
	...
	/*Configure GPIO pins : PBPin PBPin PBPin PBPin
							 PBPin PBPin */
	GPIO_InitStruct.Pin = LED2_Pin | LED1_Pin | LED8_Pin | LED7_Pin | LED6_Pin | LED5_Pin;
	GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
	GPIO_InitStruct.Pull = GPIO_NOPULL;
	GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
