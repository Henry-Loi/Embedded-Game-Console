...
5. SPI read and write operations are completed in 16 or more clock cycles (two or more bytes). The first byte contains
the SPI Address, and the following byte(s) contain(s) the SPI data. The first bit of the first byte contains the
Read/Write bit and indicates the Read (1) or Write (0) operation. The following 7 bits contain the Register Address. In
cases of multiple byte Read/Writes, data is two or more bytes:
*/
...
#define ICM20602_SPI_SCLK_PIN  GPIO_PIN_10
...
#define ICM20602_SPI_CS_PIN	 IMU_CS_Pin
#define ICM20602_SPI_CS_PORT IMU_CS_GPIO_Port
// #define ICM20602_SPI_CS_CLK	 LL_AHB1_GRP1_PERIPH_GPIOC

#define ICM20602_INT_PIN  IMU_INT_Pin
#define ICM20602_INT_PORT IMU_INT_GPIO_Port
// #define ICM20602_INT_CLK  LL_AHB1_GRP1_PERIPH_GPIOC

//////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////
#define CHIP_SELECT(ICM20602)	gpio_reset(IMU_CS)
#define CHIP_DESELECT(ICM20602) gpio_set(IMU_CS)
//////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////
...
#define WRITE_INST 0x7F
#define READ_INST  0x80
