...
void ICM20602_GPIO_SPI_Initialization(void) {
	...
	*/
	...
	SPI_InitStruct.BaudRate =
		LL_SPI_BAUDRATEPRESCALER_DIV8; // ICM-20602 MAX SPI CLK is 10MHz. But DIV2(42MHz) is available.
...
int ICM20602_DataReady(void) { return LL_GPIO_IsInputPinSet(ICM20602_INT_PORT, ICM20602_INT_PIN); }
